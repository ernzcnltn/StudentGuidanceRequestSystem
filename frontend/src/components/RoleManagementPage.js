        ...
        <div className="col-12">
          <div className="card" style={cardStyle}>
            <div className="card-header">
              <h6 className="mb-0">🚀 Quick Role Templates</h6>
            </div>
            <div className="card-body">
              <div className="row">
                  ...
                  <button 
                    ...
                    onClick={() => {
                      setNewRole({
                        ...
                        description: 'Can manage content and moderate requests',
                        is_system_role: false
                      });
              ...
              <small className={isDark ? 'text-light' : 'text-muted'}>
                Click on a template to pre-fill the create role form with common configurations
              </small>
            </div>
          </div>
        </div>
